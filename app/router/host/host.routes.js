...
const { addNewHost, getListOfHosts,  removeHost, decreaseGuestNo, updateHost, getHostById, foodService, medicalService, increaseGuestNo } = require("../../http/controllers/host.controller");
...
router.patch("/increase/:id", verifyAccessToken, expressAsyncHandler(increaseGuestNo));
